...
| Docker（distroless）  | `docker pull sunerpy/bedrock-gateway-rust` — 见 [docs/deploy/docker.md](../../docs/deploy/docker.md) |
| ECS / Fargate + ALB   | CloudFormation 一键部署 — 见 [docs/deploy/ecs.md](../../docs/deploy/ecs.md)                          |
| Lambda + Function URL | Lambda Web Adapter，无 Lambda 专属代码 — 见 [docs/deploy/lambda.md](../../docs/deploy/lambda.md)     |
...
完整架构参考、契约规则和贡献者指南，见 [AGENTS.md](../../AGENTS.md)。

缓存行为、Reasoning Budget 路径和跨区域 Inference Profile 详情，见 [docs/caching-and-reasoning.md](../../docs/caching-and-reasoning.md)。
...
贡献规范见 [docs/readme/CONTRIBUTING.md](CONTRIBUTING.md)。
...
| 缓存与推理详解   | [docs/caching-and-reasoning.md](../../docs/caching-and-reasoning.md) |
| Docker 部署      | [docs/deploy/docker.md](../../docs/deploy/docker.md)                 |
| ECS/Fargate 部署 | [docs/deploy/ecs.md](../../docs/deploy/ecs.md)                       |
| Lambda 部署      | [docs/deploy/lambda.md](../../docs/deploy/lambda.md)                 |
| 架构与契约       | [AGENTS.md](../../AGENTS.md)                                         |
